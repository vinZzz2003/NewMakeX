...
class _DoubleEliminationBracketState extends State<DoubleEliminationBracket> {
    ...
    try {
      ...
      final matches = result.rows.map((r) {
        ...
        if (data['alliance1_id'] != null && int.parse(data['alliance1_id'].toString()) > 0) {
          final alliance = _getAllianceById(int.parse(data['alliance1_id'].toString()));
        ...
        if (data['alliance2_id'] != null && int.parse(data['alliance2_id'].toString()) > 0) {
          final alliance = _getAllianceById(int.parse(data['alliance2_id'].toString()));
      ...
      if (autoProcessByes && _autoProcessEnabled && !_isResetting && _numAlliances > 4) {
  ...
  Map<String, dynamic>? _getAllianceById(int id) {
    try {
      return _alliances.firstWhere((a) => int.parse(a['alliance_id'].toString()) == id);
    } catch (e) {
      return null;
    }
  }
  ...
  Future<void> _autoProcessByeMatches() async {
    ...
    for (final row in result.rows) {
      ...
      bool hasTeam1 = alliance1IdStr != null && int.tryParse(alliance1IdStr) != null && int.parse(alliance1IdStr) > 0;
      bool hasTeam2 = alliance2IdStr != null && int.tryParse(alliance2IdStr) != null && int.parse(alliance2IdStr) > 0;
  ...
  Future<String?> _getNextMatchId(MySQLConnection conn, int matchId, String type) async {
    final result = await conn.execute("""
  ...
  Future<int> _getNextMatchPosition(MySQLConnection conn, int matchId, String type) async {
    final result = await conn.execute("""
  ...
  Future<void> _generateDoubleEliminationBracket() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('✅ Double elimination bracket generated with ${_matches.length} matches'),
            backgroundColor: Colors.green,
          ),
        );
      }
  ...
  Future<void> _generateFlexibleBracket() async {
    ...
    print("🎯 Bracket size: $_bracketSize (next power of 2 after $_numAlliances)");
    ...
    List<int> allianceIds = _alliances.map((a) => int.parse(a['alliance_id'].toString())).toList();
  ...
  Widget _buildMatchCard(Map<String, dynamic> match, Color sideColor) {
    ...
    int? alliance1Id = alliance1IdStr != null ? int.tryParse(alliance1IdStr) : null;
    int? alliance2Id = alliance2IdStr != null ? int.tryParse(alliance2IdStr) : null;
    
    final hasBothTeams = (alliance1Id != null && alliance1Id > 0) &&
                         (alliance2Id != null && alliance2Id > 0);
    final hasOneTeam = (alliance1Id != null && alliance1Id > 0) ||
                       (alliance2Id != null && alliance2Id > 0);
    final hasNoTeams = (!hasBothTeams && !hasOneTeam);
    
    final winnerIdStr = match['winner_alliance_id']?.toString();
    final isPlayed = winnerIdStr != null && int.tryParse(winnerIdStr) != null && int.parse(winnerIdStr) > 0;
    ...
    if (roundName == 'GF2') {
      final hasAnyTeam = (alliance1Id != null && alliance1Id > 0) || 
                         (alliance2Id != null && alliance2Id > 0);
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontWeight: winnerIs1 ? FontWeight.bold : FontWeight.normal,
                        fontSize: 10,
                      ),
                      maxLines: 2,
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontWeight: winnerIs2 ? FontWeight.bold : FontWeight.normal,
                        fontSize: 10,
                      ),
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
            ...
            return Column(
              ...
              children: [
                ...
                ...matches.asMap().entries.map((entry) {
                  ...
                  return Container(
                    margin: EdgeInsets.only(bottom: index < matches.length - 1 ? rowGap : 0),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                ...grandFinalMatches.map((match) => Padding(
            ...
            children: [
              OutlinedButton.icon(
                ...
                icon: _isResetting
                    ...
                    : const Icon(Icons.restart_alt, color: Colors.orange, size: 20),
                label: Text(
  ...
  Future<void> _showMatchScoreDialog(Map<String, dynamic> match) async {
    ...
    final winnerIdStr = match['winner_alliance_id']?.toString();
    final hasWinner = winnerIdStr != null && int.tryParse(winnerIdStr) != null && int.parse(winnerIdStr) > 0;
    ...
    if ((alliance1Id == null || alliance1Id == 0) && (alliance2Id != null && alliance2Id > 0)) {
        ...
        builder: (ctx) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: const Text('ADVANCE', style: TextStyle(color: Colors.black)),
            ),
          ],
        ),
      );
      ...
      return;
    } else if ((alliance2Id == null || alliance2Id == 0) && (alliance1Id != null && alliance1Id > 0)) {
        ...
        builder: (ctx, setState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              if (match['alliance1_id'] != null && int.parse(match['alliance1_id'].toString()) > 0)
                ListTile(
              ...
              if (match['alliance2_id'] != null && int.parse(match['alliance2_id'].toString()) > 0)
                ListTile(
  ...
  if (roundName.startsWith('W')) {
    ...
    if (round > 1) {
      ...
      final hasWinner1 = result1.rows.isNotEmpty && 
          result1.rows.first.assoc()['winner_alliance_id'] != null &&
          int.parse(result1.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
      final hasWinner2 = result2.rows.isNotEmpty && 
          result2.rows.first.assoc()['winner_alliance_id'] != null &&
          int.parse(result2.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
    ...
    if (round == 1) {
      ...
      final hasLoser1 = result1.rows.isNotEmpty && 
          result1.rows.first.assoc()['winner_alliance_id'] != null &&
          int.parse(result1.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
      final hasLoser2 = result2.rows.isNotEmpty && 
          result2.rows.first.assoc()['winner_alliance_id'] != null &&
          int.parse(result2.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
      ...
      final hasL1Winner = resultL1.rows.isNotEmpty && 
          resultL1.rows.first.assoc()['winner_alliance_id'] != null &&
          int.parse(resultL1.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
      ...
      final hasW2Winner = resultW2.rows.isNotEmpty && 
          resultW2.rows.first.assoc()['winner_alliance_id'] != null &&
          int.parse(resultW2.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
      ...
      final hasL3Winner = resultL3.rows.isNotEmpty && 
          resultL3.rows.first.assoc()['winner_alliance_id'] != null &&
          int.parse(resultL3.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
      ...
      final hasW3Winner = resultW3.rows.isNotEmpty && 
          resultW3.rows.first.assoc()['winner_alliance_id'] != null &&
          int.parse(resultW3.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
    ...
    final hasWinnerFinal = winnerFinalResult.rows.isNotEmpty && 
        winnerFinalResult.rows.first.assoc()['winner_alliance_id'] != null &&
        int.parse(winnerFinalResult.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
    final hasLoserFinal = loserFinalResult.rows.isNotEmpty && 
        loserFinalResult.rows.first.assoc()['winner_alliance_id'] != null &&
        int.parse(loserFinalResult.rows.first.assoc()['winner_alliance_id'].toString()) > 0;
    ...
    final loserFinalWinner = loserFinalResult.rows.first.assoc()['winner_alliance_id'];
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Error loading bracket', style: TextStyle(color: Colors.redAccent)),
            const SizedBox(height: 8),
            Text(_error!, style: TextStyle(color: Colors.white38, fontSize: 12), textAlign: TextAlign.center),
            const SizedBox(height: 16),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.account_tree, size: 64, color: Color(0xFFFFD700)),
            ),
            const SizedBox(height: 24),
            Text('No Bracket Generated Yet', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w800)),
            const SizedBox(height: 8),
            Text('${_alliances.length} alliances detected', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 14)),
            const SizedBox(height: 24),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ...
                IconButton(
                  icon: Container(
                    ...
                    child: const Icon(Icons.settings_rounded, color: Color(0xFFFFD700), size: 20),
                  ),
